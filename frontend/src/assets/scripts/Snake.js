...
export class Snake extends GameObject {
    constructor(info, gamemap) {
        ...
        this.cells = [new SnakeCell(info.r, info.c)];
        this.next_cell = null;

        this.speed = 5;
        this.direction = -1; // -1表示初始无状态，0123上右下左
        this.status = "static"; // static静止 move正在移动 die死亡

        this.dr = [-1, 0, 1, 0];
        this.dc = [0, 1, 0, -1];

        this.step = 0;
        this.eps = 1e-2; // 两个点坐标小于eps时认为他们重合
    ...
    check_tail_increasing() { // 检测当前回合，蛇的长度是否会增加
